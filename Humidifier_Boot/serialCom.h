...
extern serialSlave_t serialSlave;
extern uartBuffer_t rxBuffer;
extern uartBuffer_t txBuffer;

/*===== PROTOTIPI FUNZIONI ==================================================*/
#define isNewProcessingMsg()          (serialSlave.procMsg)
#define resetNewProcessingMsg()       (serialSlave.procMsg = FALSE)
#define setNewProcessingMsg()         (serialSlave.procMsg = TRUE)
#define setTxRequestMsg()             (txBuffer.bufferFlags.txRequest = TRUE)
